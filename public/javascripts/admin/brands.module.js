class Brand {
    ...
    bindEvents() {
        ...
        if (this.addBrandBtn) {
            this.addBrandBtn.addEventListener('click', () => {
                this.openModal('modalAddBrand'); // id modal Add Brand
            });
        }
        ...
        this.setupImagePreview('addBrandLogo', 'addBrandPreview');
        this.setupImagePreview('editBrandLogo', 'editBrandPreview');
    ...
    fillEditForm(brand) {
        ...
        this.formEditBrand.querySelector('#editBrandDesc').value = brand.description || '';
        const preview = document.getElementById('editBrandPreview');
        if (brand.imageUrl) {
            preview.src = brand.imageUrl;
            preview.style.display = 'block';
        } else {
            preview.src = '';
            preview.style.display = 'none';
