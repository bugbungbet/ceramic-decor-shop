...
class Product {
    ...
    fillEditForm(product) {
        ...
        form.querySelector('#editProductIntro').value = product.introduction || '';
        form.querySelector('#editProductDetails').value = product.details || '';
        form.querySelector('#editProductDisplaySuggestion').value = product.displaySuggestion || '';
        form.querySelector('#editProductPreservationGuide').value = product.preservationGuide || '';
